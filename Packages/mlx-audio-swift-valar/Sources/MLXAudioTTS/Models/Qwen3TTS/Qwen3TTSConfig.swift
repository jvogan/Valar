...
public struct Qwen3TTSTalkerConfig: Codable, Sendable {
    ...
    var spkId: [String: IntOrIntArray]?
    var spkIsDialect: [String: StringOrNumber]?
    ...
    public init(from decoder: Swift.Decoder) throws {
        ...
        spkId = try c.decodeIfPresent([String: IntOrIntArray].self, forKey: .spkId)
        spkIsDialect = try c.decodeIfPresent([String: StringOrNumber].self, forKey: .spkIsDialect)
    }
