...
func loadWeights(from directory: URL) throws -> [String: MLXArray] {
    ...
    let searchDirectories = [
        directory,
        directory.appendingPathComponent("weights", isDirectory: true),
    ]

    var weights: [String: MLXArray] = [:]
    for searchDirectory in searchDirectories where fileManager.fileExists(atPath: searchDirectory.path) {
